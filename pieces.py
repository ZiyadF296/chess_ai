...
class Piece():
    ...
    # Returns a Move object with (x_from, y_from) set to the piece current position.
...
class Knight(Piece):
    ...
    def __init__(self, x, y, color):
        super(Knight, self).__init__(
            x, y, color, Knight.PIECE_TYPE, Knight.VALUE)
...
class Bishop(Piece):
    ...
    def __init__(self, x, y, color):
        super(Bishop, self).__init__(
            x, y, color, Bishop.PIECE_TYPE, Bishop.VALUE)
